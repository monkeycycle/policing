...
wfp_releases_2018_2021_annual <- prepare_plot(p_releases_2018_2021_annual)

ggsave_pngpdf(wfp_releases_2018_2021_annual, "wfp_releases_2018_2021_annual", width_var=8.66, height_var=6, dpi_var=96, scale_var=1, units_var="in")
