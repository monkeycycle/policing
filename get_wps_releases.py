...
URL = "https://www.winnipeg.ca/police/press/allreleases.stm"
...
# We're only interested in press links under the police branch of city of winnipeg website
  ...
  if link_href.find(police_path) != -1:
      ...
      for link_2 in page_year_month_links:
          ...
          if link_2_href.find(police_path) != -1:
              ...
              release_line = '"' + url_year_month_day + '"'
              ...
              for heading in headings:
                if((heading.text.strip() != "Was this information helpful?") | (heading.text.strip() != "How can we make this web page better?")):
                  release_line  = release_line + "|" + '"' + heading.text.strip() + '"'
